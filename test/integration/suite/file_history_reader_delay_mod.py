...
class FileHistoryReaderDelayMod:
    ...
    def slow_down(self, delay):
        ...
        original_send_to_callback = reader.send_file_to_callback
        ...
        reader.send_file_to_callback = MagicMock(side_effect=side_effect)

    def reset_mock(self):
        self.reader.send_file_to_callback = self.original_method
